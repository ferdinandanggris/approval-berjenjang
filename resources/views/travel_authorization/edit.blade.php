        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 mt-3">
                    <form action="{{ route('travel_authorization.update', ['id' => $travelAuthorization->id]) }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3 form-group row">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control" name="reason" placeholder="Leave a reason here" required id="floatingTextarea">{!!$travelAuthorization->reason!!}</textarea>
                            </div>
                        </div>
                        <div class="mb-3 form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control"
                                    id="start_date" name="start_date" required value="{{$travelAuthorization->start_date}}">
                            </div>
                        </div>
                        <div class="mb-3 form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="date" class="form-control"
                                  id="end_date" name="end_date" required value="{{$travelAuthorization->end_date}}">
                          </div>
                      </div>
